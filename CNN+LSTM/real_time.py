...
frame_length = 50
slide = 12                    #
threshold = 0.9                 # list of array containing probability, and it displays max probablity
eng_text = "Welcome"

# Load the CNN model
cnnLstm_model_path = 'model.keras'
cnn_model = load_model(cnnLstm_model_path)
...
def predict_sign(sequence):
    ...
    predictions = cnn_model.predict(sequence.reshape(1, frame_length, 225))
    print(predictions)
